...
Data=importdata('Extended_Example.xlsx');

Q=Data.data(1:end,4:end);


Q_3D=permute(reshape(Q,12,[],size(Q,2)),[2,1,3]);
...
xlabel('\lambda')
axis([0 1 0 0.12])
text(0.1*(1-(0))+0,1.08*(0.12-(0))+0,'c)','FontSize',12)
set(gca,'FontSize',12)
...
xlabel('\lambda')
axis([0 1 0 0.7])
text(0.1*(1-(0))+0,1.08*(0.7-(0))+0,'d)','FontSize',12)
set(gca,'FontSize',12)
...
ylabel('Mean Error')
axis([0 1 0 0.12])
text(0.1*(1-(0))+0,1.08*(0.12-(0))+0,'a)','FontSize',12)
set(gca,'FontSize',12)
...
axis([0 1 0 0.8])
text(0.1*(1-(0))+0,1.08*(0.8-(0))+0,'b)','FontSize',12)
...
axis([0 0.1 0 0.11])
text(0.1*(0.1-(0))+0,1.08*(0.11-(0))+0,'c)','FontSize',12)
...
axis([0 0.55 0 0.75])
text(0.1*(0.55-(0))+0,1.08*(0.75-(0))+0,'d)','FontSize',12)
